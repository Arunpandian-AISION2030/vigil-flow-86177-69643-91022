...
export const Header = () => {
  ...
  return (
    <header className="neu-card border-b border-border sticky top-0 z-50 backdrop-blur-sm">
      <div className="container mx-auto px-3 sm:px-4 py-2 sm:py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3 cursor-pointer" onClick={() => navigate("/home")}>
            <div className="p-1.5 sm:p-2 rounded-xl animate-scale-in shrink-0" style={{ background: 'linear-gradient(135deg, hsl(214 90% 60%), hsl(270 70% 65%))' }}>
