...
const Recordings = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Create a simple image representation (in production, extract frames from video)
        ...
        try {
          ...
          if (response.ok) {
            ...
            toast({
              ...
              description: `Detected ${analysisData.detections.length} objects`,
            });
          } else {
          ...
          toast({
            ...
            description: "Could not analyze video",
            variant: "destructive",
          });
        } finally {
          setAnalyzing(false);
      ...
      <div className="container mx-auto p-6 space-y-6 max-w-7xl">
        ...
        <Card className="gov-section p-6">
          ...
          <div className="space-y-4">
            ...
            {selectedFile && (
              <div className="flex items-center justify-between p-4 gov-card">
